...
{
    public class EngineeringCheckBox : Control, IThemeable
    {
        ...
        private void DrawGlyph(Graphics g, Rectangle bounds)
        {
            ...
            g.FillRectangle(fillBrush, softBounds);

            using Pen borderPen = new Pen(borderColor, 1.25f);
            g.DrawRectangle(borderPen, softBounds.X, softBounds.Y, softBounds.Width, softBounds.Height);
            ...
            Color checkColor = Enabled ? Color.White : palette.TextDisabled;
            ...
            PointF p1 = new PointF(bounds.Left + bounds.Width * 0.25f, bounds.Top + bounds.Height * 0.52f);
            PointF p2 = new PointF(bounds.Left + bounds.Width * 0.43f, bounds.Top + bounds.Height * 0.70f);
            PointF p3 = new PointF(bounds.Left + bounds.Width * 0.76f, bounds.Top + bounds.Height * 0.32f);
